module github.com/WhizardTelemetry/whizard-adapter
...
require (
	...
	github.com/kubesphere/whizard v0.0.0
...
replace (
	github.com/kubesphere/whizard v0.0.0 => github.com/WhizardTelemetry/whizard v0.0.0-20220929123125-acd82aa4c63a
